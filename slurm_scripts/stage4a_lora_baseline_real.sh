...
# ======== Variables (NATURAL-SHIFT: real Van Gogh paintings as attacker data) ========
export MODEL_NAME="CompVis/stable-diffusion-v1-4"
export OUTPUT_DIR="results/relearning_real/without_imma"
...
# ======== Run LoRA (without IMMA, real-painting attack) ========
echo "================================"
echo "Running LoRA WITHOUT IMMA  -- attacker uses REAL paintings"
echo "================================"
...
echo ""
echo "================================"
echo "Stage 4a-real finished at $(date)"
echo "================================"
ls -lh $OUTPUT_DIR/
