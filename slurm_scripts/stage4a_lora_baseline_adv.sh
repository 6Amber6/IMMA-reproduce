...
# ======== Variables (Ex2 Phase 2.2: PGD adversarial attack, NO IMMA) ========
export MODEL_NAME="CompVis/stable-diffusion-v1-4"
export OUTPUT_DIR="results/relearning_adv/without_imma"
...
echo "================================"
echo "Running LoRA WITHOUT IMMA  -- attacker uses PGD-perturbed SD-gen images"
echo "================================"
...
echo ""
echo "================================"
echo "Stage 4a-adv finished at $(date)"
echo "================================"
