...
# ======== Variables (Ex2 Phase 2.2: PGD adversarial attack, WITH IMMA) ========
export MODEL_NAME="CompVis/stable-diffusion-v1-4"
export IMMA_RESULTS_DIR="results/relearning"
export OUTPUT_DIR="results/relearning_adv/with_imma"
export TRAIN_DATA_DIR="data/vangogh_adv"
...
[ -f $IMMA_CKPT ] || { echo "ERROR: IMMA checkpoint missing"; exit 1; }
...
echo "Adversarial training data count: $(ls $TRAIN_DATA_DIR/*.png | wc -l)"
echo ""

echo "================================"
echo "Running LoRA WITH IMMA  -- attacker uses PGD-perturbed SD-gen images"
echo "================================"
...
echo ""
echo "================================"
echo "Stage 4b-adv finished at $(date)"
echo "================================"
